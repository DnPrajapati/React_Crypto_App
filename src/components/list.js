  ...
  const columns = [
    {
      ...
      width: "5%",
      render: (market_data) => (
        <h3 className="__text_align">{market_data.market_cap_rank}</h3>
      ),
    },
    {
      align: "centre",
    ...
    },
    {
      ...
      render: (market_data) => (
        <h3 className="__text_align">
          ${convertToInternationalCurrencySystem(market_data.total_volume.usd)}
        </h3>
      ),
    },
    {
